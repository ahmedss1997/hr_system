  ...
  >
    <v-list color="transparent" dense class="mt-6 pb-0">
      <div style="max-height: calc(100vh - 60px)">
        <span
          v-if="!miniSide"
          class="d-block px-5 accent--text my-2 font-weight-bold"
          >Main</span
        >
        <v-list-item
        ...
        >
          <template v-if="!item.includeList">
            <v-list-item-icon class="mx-1">
              <v-icon color="txtOnPrimary">{{ item.action }}</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title
                v-if="!miniSide"
        ...
        <v-list-item
          ...
          :to="!board.includeList ? board.path || '' : ''"
          active-class="active"
          link
          dense
        ...
        >
          <template v-if="!board.includeList">
            <v-list-item-icon class="mx-1">
              <v-icon color="txtOnPrimary">{{ board.action }}</v-icon>
            </v-list-item-icon>
            <v-list-item-content>
              <v-list-item-title
                v-if="!miniSide"
